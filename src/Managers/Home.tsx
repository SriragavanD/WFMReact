 ...
 const ManagerHome=({employeeData,getEmployee,sendRequest}:any)=>{
    ...
    return (
                ...
                <tbody>
                    {
                        ...
                        return(
                            <tr key={x.EmployeeId}>
                                ...
                                <td className="text-center"><button className="btn btn-light" onClick={() => enableSoftLock({x})}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-lock" viewBox="0 0 16 16">
      ...
      <Modal.Header closeButton>
        <Modal.Title className="modalcolor">Request</Modal.Title>
      </Modal.Header>
                        ...
                        <Modal.Body>
                            <div className="form-outline">
                                ...
                                <div className="form-group">
                                <label className="textcolor"> Type Your comments:</label>
