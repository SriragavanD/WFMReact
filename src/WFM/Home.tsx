                        ...
                        wfmData.map((x: any) => {
                            return (
                                <tr key={x.EmployeeId}>
                                    ...
                                    <td className="text-center"><button className="btn btn-light" onClick={() => approvesoftlock({ x })} ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-lock" viewBox="0 0 16 16">
                ...
                {enableRequest ?
                    ...
                    <Modal show={show} onHide={handleClose}>
                        ...
                        <div className="form-group">
                            ...
                            <select onClick={ddvalue.bind(this)} className="statusDD" >
                                {/* <option>--select--</option> */}
                                <option>Approve</option>
                                <option>Reject</option>
                            </select>
                            <span>{seterrormsg}</span>
                        </div>
